/**
 * crypto.subtle은 Secure Context(HTTPS 또는 localhost)에서만 존재한다.
 * IP+HTTP로 서빙되는 LAN/NAS 배포에서도 오디오 캐시 키를 만들 수 있도록,
 * crypto.subtle이 없을 때는 순수 JS SHA-256 구현으로 대체한다.
 */
...
// FIPS 180-4 SHA-256 상수(처음 64개 소수의 세제곱근 소수부)
